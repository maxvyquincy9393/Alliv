      ...
      <div className="shell-content space-y-8 pb-16">
        <section className="panel p-6 sm:p-8 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <h1 className="text-3xl font-semibold text-white">Build briefs with the right crew.</h1>
        ...
        <section className="panel p-4 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            ...
            {filteredProjects.map((project, index) => (
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <span className="px-3 py-1 rounded-full text-xs bg-emerald-400/15 text-emerald-200">
                ...
                <div className="flex flex-wrap gap-2">
                  {project.tags?.map((tag) => (
                    <span
                      key={tag}
                      className="text-xs rounded-full border border-white/10 px-3 py-1 text-white/70"
                    >
                      {tag}
                    </span>
                  ))}
